...
export const en = {
  ...
  "pushOptIn.status.addressChangeError": "We couldn't update your notification address. Please try again.",
...
export const mi: Record<TranslationKey, string> = {
  ...
  "pushOptIn.status.addressChangeError": "Kāore i taea te whakahōu i tō wāhitau whakamōhio. Tēnā koa, whakamātauria anō.",
